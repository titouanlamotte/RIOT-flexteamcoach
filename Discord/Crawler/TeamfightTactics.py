...
class masterdata:
    ...
    def addsummoner(self, ids):
        ...
        for summ in ids:
            time.sleep(2)
            r = Consummer.getcall(str('https://euw1.api.riotgames.com/tft/summoner/v1/summoners/by-name/' +summ), secrets.TFTheaders)
            if r == False:
                continue
    ...
    def addmatches(self):
        ...
        for puuid in results:
            ...
            #pprint(puuid)
            #https://euw1.api.riotgames.com/tft/league/v1/entries/by-summoner/*
            r = Consummer.getcall(str('https://europe.api.riotgames.com/tft/match/v1/matches/by-puuid/' +puuid+'/ids?count=20'), secrets.TFTheaders)
            ...
            if r == False:
                ...
                for match in matchlist:
                    ...
                    if (match,) in results:
                        ...
                        time.sleep(2)
                        #https://euw1.api.riotgames.com/tft/league/v1/entries/by-summoner/*
                        r = Consummer.getcall(str('https://europe.api.riotgames.com/tft/match/v1/matches/' +match), secrets.TFTheaders)
                        thismatch=r.json()
                        #pprint(thismatch)
